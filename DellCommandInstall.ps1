...
Invoke-WebRequest -Uri "https://dl.dell.com/FOLDER11563484M/1/Dell-Command-Update-Windows-Universal-Application_P83K5_WIN_5.3.0_A00.EXE" -OutFile "C:\Users\Public\Dell-Command-Update-Windows-Universal-Application_P83K5_WIN_5.3.0_A00.EXE" -Headers $headers
Write-Host 'Extracting Dell Command Update Installer...'
Start-Process cmd.exe -Verb runAs -ArgumentList "/c C:\Users\Public\Dell-Command-Update-Windows-Universal-Application_P83K5_WIN_5.3.0_A00.EXE /s /e=C:\Users\Public\DellCommandInstall" -Wait
...
Remove-Item C:\Users\Public\Dell-Command-Update-Windows-Universal-Application_P83K5_WIN_5.3.0_A00.EXE
